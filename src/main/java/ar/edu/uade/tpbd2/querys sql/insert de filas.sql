insert into usuarios (nickname, nombre,apellido, domicilio, categorizacion, contrasena) 
values	('franlee99', 'francisco', 'lee','calle 123','low' , '1234'),
		('gabo', 'gabriel', 'rios','calle 456','medium' , '5678'),
		('agus', 'agustin', 'grigaliunas','calle 789','high' , '9012');
			

insert into catalogo_productos (productoID,nombre, marca, descripcion, precio, stockactual, categoria)
...
insert into det_facturacion (ID_facturacion,productoID, cantidad, precio_unit) 
values	(1,'1',12, 250000),
		(2,'3',10,100000),
		(3,'1000',15,80000);
